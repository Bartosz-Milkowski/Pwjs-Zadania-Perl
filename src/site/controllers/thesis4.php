...
class ZaswiadczeniaControllerThesis4 extends JControllerLegacy
{
    ...
    public function edit()
    {
        $postData = JFactory::getApplication()->input->post;
        $array = $postData->getArray();
        $item = $this->getModel('item')->getItem4ById($array['id']);
    ...
    public function delete()
    {
        ...
        $item = $this->getModel('item')->getItem4ById($index);
        ...
        if ($access == true) {
            ...
            $query->delete($db->quoteName('#__thesis_form4'));
    ...
    public function send()
    {
        ...
        $input = JFactory::getApplication()->input;
        $id = $input->get('id', 0);
        $item = $this->getModel('item')->getItem4ById($id);
        $form = JTable::getInstance('ThesisForm4', 'ZaswiadczeniaTable');
