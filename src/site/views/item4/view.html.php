...
class ZaswiadczeniaViewItem4 extends JViewLegacy
{
    function checkAccess()
    {
        $user = JFactory::getUser();
        $id = JFactory::getApplication()->input->getInt('id', 0);
        $formData = JTable::getInstance('ThesisForm4', 'ZaswiadczeniaTable');
        $formData->load($id);
    ...
    function display($tpl = null)
    {
        ...
        $form1Data = JTable::getInstance('ThesisForm4', 'ZaswiadczeniaTable');
